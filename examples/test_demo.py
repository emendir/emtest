...
# Module-level fixture that runs once for all tests in this file
...
# DUAL EXECUTION PATTERN: This block only runs when executing as 'python test_demo.py'
# It does NOT run when using 'pytest test_demo.py'
if __name__ == "__main__":
    # Use emtest's custom test runner with specific settings:
    run_pytest(
        test_path=__file__,              # Run tests in this file
    ...
    # Compare the outputs:
    # - 'python test_demo.py' gives clean, minimal output
    # - 'pytest test_demo.py' gives standard pytest verbose output
